          ...
          <div className="max-w-7xl mx-auto px-6 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-foreground font-semibold text-lg mb-6">Programs</h3>
                <ul className="space-y-3">
                  {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-foreground font-semibold text-lg mb-6">Connect with Us</h3>
            ...
            <div className="max-w-7xl mx-auto px-6 py-6">
              ...
              >
                <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-muted-foreground">
                  <span>© 2025 Kin-G Technologies Pvt. Ltd. All rights reserved.</span>
                </div>
