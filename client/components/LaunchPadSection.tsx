    ...
    <section className="px-3 mb-5">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          {/* <p className="text-lg md:text-sm text-muted-foreground max-w-4xl mx-auto leading-relaxed">
        ...
        >
          <div className="relative overflow-hidden">
            ...
            <div className="relative min-h-[360px] sm:min-h-[400px] md:min-h-[200px]">
              <AnimatePresence initial={false} custom={direction} mode="wait">
                <motion.div
                  ...
                  className="w-full"
                >
                  <Card className="group bg-transparent backdrop-blur-sm border-border/10 relative overflow-hidden h-full cursor-pointer  transition-all duration-300">
                    <div className="absolute inset-0 dark:futuristic-grid opacity-0 group-hover:opacity-20 transition-opacity duration-300" />
                    <Link to="/launchpad" className="block h-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-5 w-full items-center 
                          ...
                          <div className="md:col-span-2 flex justify-center">
                            <img
                              ...
                              loading="lazy"
                              draggable={false}
                              style={highlight.title === "Additional Mastery Certifications" ? { filter: "invert(1)" } : {}}
                            />
                            <img
